...
const IslamicHistory = () => {
  ...
  const outlineItems = [
    ...
    { id: 2, outline: 'Caliphate', content: '' },
    { id: 3, outline: 'Ummayads', content: '' },
    {
      id: 4,
      outline: 'Abbasids',
      content: '',
    },
    {
      id: 5,
      outline:
        'Muslim relations with other faiths (Ahl al-Kitab and dhimmi status)',
      content: '',
    },
    {
      id: 6,
      outline: 'Collapse of the Ottoman Empire (pan Islamism)',
      content: '',
    },
    {
      id: 7,
      outline: 'Islamic Resurgence',
      content: '',
    },
    {
      id: 8,
      outline: 'Arab - Islam and the present situation in Africa.',
      content: '',
    },
  ];
    ...
    <div>
      ...
      <div className="bg-[#F9FAFB]">
        <div className="pt-10 lg:pb-20 pb-10 lg:w-[80vw] w-[90vw] mx-auto">
          ...
          <img
            src="/assets/course-imgs/img-two.jpg"
            alt="hero"
